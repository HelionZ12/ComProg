...
namespace GunBlitz
{
    public partial class Tutorial_lvl_2 : Form
    {
        ...
        WaveOut Music;
        //PlayerMovement
        bool goLeft, goRight, Jump, hasGun, interact, GameOver, CompleteObj,reload,run;
        ...
        {
            InitializeComponent();
            BGM = new AudioFileReader("Moosic.wav");
            Music = new();
            Music.Init(BGM);
            ShootSfx = new SoundPlayer("PlayerShoot.wav");
            JumpSfx = new SoundPlayer("PlayerJump.wav");
            BGM.CurrentTime = new TimeSpan(0L);
            Music.Play();
        ...
        private void MainEventTimer(object sender, EventArgs e)
        {
            ...
            {
                GameTimer.Stop();
                MessageBox.Show("Well Done You Finished the Tutorial Levels!");
                GoToNextLvl();
            }
            //Kill Enemy
        ...
        private void KeyIsDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Space && hasGun == true && reload == false && ammo > 0)
            {
                ...
                if (Direction == "left") 
                {
                    player.Image = Properties.Resources.newShootLeft;
                    ;
                ...
                if (Direction == "right") 
                {
                    player.Image = Properties.Resources.newShootRight;
                }
                ShootSfx.Play();
            }
        ...
        private void ShootGun(string direction)
        {
            ...
            shootBullet.bulletLeft = player.Left + (player.Width / 5);
